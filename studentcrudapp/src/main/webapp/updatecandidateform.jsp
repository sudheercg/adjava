		...
		<nav class="navbar navbar-expand-fmd navbar-dark"
			...
			<ul class="navbar-nav">
				<li><a href="<%=request.getContextPath()%>/list"
					class="nav-link">Candidates List</a></li>
			</ul>
		</nav>
	</header>
	<br>
				...
				<form action="update" method="post">
					...
					<fieldset class="form-group">
						<label>Gender</label> <input type="text"
							value="<c:out value='${candidate.gender}' />"
					...
					<fieldset class="form-group">
						<label>Email</label> <input type="text"
							value="<c:out value='${candidate.email}' />" class="form-control"
							name="email">
					</fieldset>

					<fieldset class="form-group">
						<label>Qualification</label> <input type="text"
							value="<c:out value='${candidate.qualification}' />"
							class="form-control" name="qualification">
					</fieldset>

					<fieldset class="form-group">
						<label>State</label> <input type="text"
							value="<c:out value='${candidate.state}' />" class="form-control"
							name="state">
					</fieldset>
